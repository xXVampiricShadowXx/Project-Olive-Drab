...
A town is controlled by the side that has an infantry unit physically present, has no opposing unit contesting the same town sector, and can maintain a credible presence there. The game master marks control on the master map and reports the change to both sides.

Control is one of three states:

- **Controlled:** One side meets all control requirements.
- **Contested:** Opposing infantry units are present or control cannot be established safely.
- **Uncontrolled:** Neither side has an eligible presence.
